    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 50, background: "#0a0e0c", fontFamily: "'SF Pro Display', -apple-system, BlinkMacSystemFont, sans-serif", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
        ...
        <div style={slideBase(2)}>
          ...
          {/* Google */}
          <button onClick={() => { /* TODO: Supabase Auth — Google */ }} style={{ width: "100%", padding: 15, borderRadius: 14, background: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: "pointer", marginBottom: 8, boxShadow: "0 4px 16px rgba(110,252,180,0.1)" }}>
          ...
          {/* Apple */}
          <button onClick={() => { /* TODO: Supabase Auth — Apple */ }} style={{ width: "100%", padding: 15, borderRadius: 14, background: "#000", border: "1px solid rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: "pointer", marginBottom: 12 }}>
