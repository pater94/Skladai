      ...
      >
        ...
        <div style={slideBase(2)} data-scrollable="true">
          ...
          <button
            ...
            style={{ width: "100%", padding: 15, borderRadius: 14, background: "rgba(255,255,255,0.5)", border: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: loginBusy ? "not-allowed" : "pointer", marginBottom: 8, opacity: loginBusy && loginBusy !== "google" ? 0.5 : 1 }}
          >
          ...
          <button
            ...
            disabled={loginBusy !== null}
            style={{ width: "100%", padding: 15, borderRadius: 14, background: "#000", border: "1px solid rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, cursor: loginBusy ? "not-allowed" : "pointer", marginBottom: 12, opacity: loginBusy && loginBusy !== "apple" ? 0.5 : 1 }}
          >
