...
const VALUE_CARDS = [
  {
    icon: "💰",
    title: "Oszczędzaj",
    desc: "Unikaj produktów, za które przepłacasz — sprawdzaj skład przed zakupem",
  },
  {
    icon: "🛡️",
    title: "Chroń zdrowie",
    desc: "Wykrywaj szkodliwe składniki i alergeny zanim trafią na Twój talerz",
  },
  {
    icon: "📈",
    title: "Śledź postępy",
    desc: "Dziennik, cele kaloryczne i osiągnięcia — wszystko w jednym miejscu",
  },
];
    ...
    >
      ...
      <div className="flex flex-col items-center z-10 w-full max-w-sm px-6 pt-16">
        ...
        <p className="text-gray-500 text-[14px] font-medium mb-10">
          Skanuj. Analizuj. Żyj zdrowiej.
        </p>

        {/* Value cards carousel */}
        <div className="w-full relative h-[120px] mb-10">
          {VALUE_CARDS.map((card, i) => (
            <div
              ...
              style={{
                ...
                transform: activeCard === i ? "translateY(0) scale(1)" : "translateY(10px) scale(0.96)",
            ...
            >
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="text-[32px] flex-shrink-0">{card.icon}</span>
                  <div>
                    <p className="text-white font-bold text-[15px] mb-1">{card.title}</p>
                    <p className="text-gray-400 text-[13px] leading-snug">{card.desc}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 flex gap-2">
            {VALUE_CARDS.map((_, i) => (
              <button
                ...
                style={{
                  background: activeCard === i ? "#10b981" : "rgba(255,255,255,0.15)",
      ...
      <div className="z-10 w-full max-w-sm px-6 pb-10 flex flex-col items-center gap-3">
        ...
        <button
          ...
          onClick={() => {
            // TODO: Supabase Auth — Google provider
          }}
        >
        ...
        <button
          ...
          onClick={() => {
            // TODO: Supabase Auth — Apple provider
          }}
        >
